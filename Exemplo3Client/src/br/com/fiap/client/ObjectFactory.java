...
public class ObjectFactory {
    ...
    private final static QName _ListarResponse_QNAME = new QName("http://ws.exemplos.fiap.com/", "listarResponse");
    private final static QName _Novo_QNAME = new QName("http://ws.exemplos.fiap.com/", "novo");
    private final static QName _Exception_QNAME = new QName("http://ws.exemplos.fiap.com/", "Exception");
    private final static QName _NovoResponse_QNAME = new QName("http://ws.exemplos.fiap.com/", "novoResponse");
    private final static QName _Autenticado_QNAME = new QName("http://ws.exemplos.fiap.com/", "autenticado");
    private final static QName _Listar_QNAME = new QName("http://ws.exemplos.fiap.com/", "listar");
    private final static QName _AutenticadoResponse_QNAME = new QName("http://ws.exemplos.fiap.com/", "autenticadoResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.exemplos.fiap.com/", name = "listarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.exemplos.fiap.com/", name = "novo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.exemplos.fiap.com/", name = "novoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.exemplos.fiap.com/", name = "autenticado")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.exemplos.fiap.com/", name = "listar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.exemplos.fiap.com/", name = "autenticadoResponse")
