...
public interface AlunoWeb {
     ...
     */
    @WebMethod
    @WebResult(name = "listarResponse", targetNamespace = "http://ws.exemplos.fiap.com/", partName = "result")
    ...
    public ListarResponse listar(
        @WebParam(name = "listar", targetNamespace = "http://ws.exemplos.fiap.com/", partName = "parameters")
        Listar parameters,
        @WebParam(name = "Usuario", targetNamespace = "http://ws.exemplos.fiap.com/", header = true, partName = "Usuario")
        String usuario,
        @WebParam(name = "Senha", targetNamespace = "http://ws.exemplos.fiap.com/", header = true, partName = "Senha")
        String senha)
        throws Exception_Exception
    ;
     ...
     */
    @WebMethod
    @WebResult(name = "novoResponse", targetNamespace = "http://ws.exemplos.fiap.com/", partName = "result")
    ...
    public NovoResponse novo(
        @WebParam(name = "novo", targetNamespace = "http://ws.exemplos.fiap.com/", partName = "parameters")
        Novo parameters,
        @WebParam(name = "Usuario", targetNamespace = "http://ws.exemplos.fiap.com/", header = true, partName = "Usuario")
        String usuario,
        @WebParam(name = "Senha", targetNamespace = "http://ws.exemplos.fiap.com/", header = true, partName = "Senha")
