...
public class ObjectFactory {
    ...
    private final static QName _DownloadResponse_QNAME = new QName("http://exemplos.ws.fiap.com/", "downloadResponse");
    private final static QName _Upload_QNAME = new QName("http://exemplos.ws.fiap.com/", "upload");
    private final static QName _Download_QNAME = new QName("http://exemplos.ws.fiap.com/", "download");
    private final static QName _Exception_QNAME = new QName("http://exemplos.ws.fiap.com/", "Exception");
    private final static QName _UploadResponse_QNAME = new QName("http://exemplos.ws.fiap.com/", "uploadResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exemplos.ws.fiap.com/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exemplos.ws.fiap.com/", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exemplos.ws.fiap.com/", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exemplos.ws.fiap.com/", name = "Exception")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exemplos.ws.fiap.com/", name = "uploadResponse")
