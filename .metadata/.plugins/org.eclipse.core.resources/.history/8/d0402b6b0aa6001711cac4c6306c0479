 ...
 * 
 */
@WebServiceClient(name = "AlunoWebService", targetNamespace = "http://ws.exemplos.fiap.com/", wsdlLocation = "http://l2901micro23:8080/Exemplo3/AlunoWebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://l2901micro23:8080/Exemplo3/AlunoWebService?wsdl");
