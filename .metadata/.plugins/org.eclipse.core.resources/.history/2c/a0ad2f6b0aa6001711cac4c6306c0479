...
public class ObjectFactory {
    ...
    private final static QName _Usuario_QNAME = new QName("http://ws.exemplos.fiap.com/", "Usuario");
    private final static QName _Listar_QNAME = new QName("http://ws.exemplos.fiap.com/", "listar");
    private final static QName _Senha_QNAME = new QName("http://ws.exemplos.fiap.com/", "Senha");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.exemplos.fiap.com/", name = "Usuario")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.exemplos.fiap.com/", name = "Senha")
